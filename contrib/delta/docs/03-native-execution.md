...
[10-iceberg-style-kernel-read.md](archive/10-iceberg-style-kernel-read.md); a coherence
audit is in [11-kernel-read-coherence-audit.md](archive/11-kernel-read-coherence-audit.md).
