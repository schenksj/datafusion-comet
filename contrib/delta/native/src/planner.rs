...
impl ContribOperatorPlanner for DeltaScanPlanner {
    fn plan(
        ...
        let object_store_url = ctx.prepare_object_store(one_file, &object_store_options)?;
        ...
        let delta_exec = ctx.build_parquet_datasource_exec(ParquetDatasourceParams {
            required_schema: Arc::clone(&required_schema),
            ...
            default_values: None,
            session_timezone: common.session_timezone.as_str(),
